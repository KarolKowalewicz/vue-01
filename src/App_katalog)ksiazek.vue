    ...
    <div class="grid">
      <div v-for="(book, idx) in booksFromPage" :key="book.slug">
        <div class="book-item">
          ...
          <h3>{{ book.title }}</h3>
          <h4>{{ book.author }}</h4>
          <h5 class="genre">{{ book.genre }}         
            <img class="icon" v-if="book.has_audio" src="./components/icons/headphone.png" />
          <img class="icon" v-else src="./components/icons/headphoneno.png" /></h5>
